...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--adc", action="store_true", default=False, help="Activate ADC Streams"
    )
    parser.add_argument(
        "-n", "--stream_name", default="FieldLineOPM", help="Name of the LSL Stream"
    )
    parser.add_argument(
        "-id",
        "--stream_id",
        default="FieldLineOPM_sid",
        help="Unique ID of the LSL Stream",
    )
    parser.add_argument(
        "-t",
        "--duration",
    ...
    print(args.chassis)
    fLSL = FieldLineLSL.FieldLineLSL(
        ip_list=args.chassis,
        stream_name=args.stream_name,
        source_id=args.stream_id,
        stream_type="MEG",
        log_heartbeat=args.heartbeat,
        unit_T=FieldLineLSL.Unit_T_Factor.fT,
    )
    ...
    fLSL.init_sensors(
        skip_restart=not args.not_skip_restart,
        skip_zeroing=not args.not_skip_zeroing,
        adcs=args.adc,
    )
